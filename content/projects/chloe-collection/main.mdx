export const metadata = {
    ...
    "tags": ["Big"],
    "lastUpdated": "2024-11-01 12:00",
    "link": "https://drive.google.com/file/d/1y46HsckMQegCoWdjSXC8A9_Prvo4tEQA/view?usp=sharing"
}
...
- A brand new gamemode: Stunt Show
...
CompletelyCordo - descriptions for FO1 and Rally Trophy cars, pacenotes for some rally stages, time trial medal times for Professional handling and Super Author times for rally stages
...
- Having Super Author opponents (Times Only is not affected) enabled will place you in 3rd place if you only beat Gold as they count as real opponents
- Other languages are not supported, you can and will see English text interspersed between localized text
- Resetting might put you out of bounds in some spots on custom tracks
...
- The Rally HUD may show the player moving backwards when the stage path is going further away from the finish
...
This mod does not and will never be compatible with the newest version of the game on Steam, as me and the team do not approve of or tolerate the actions of Strategy First and the ZOOM Platform in any way.
